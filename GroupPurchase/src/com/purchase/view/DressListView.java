...
public class DressListView extends ListView implements OnScrollListener{

	private static final String TAG = "DressListView";
...
//	private TextView lastUpdatedTextView;
	...
	public DressListView(Context context) {
		super(context);
		init(context);
	}
	
	public DressListView(Context context, AttributeSet attrs){
		super(context, attrs);
		init(context);
	}
	
	public DressListView(Context context, AttributeSet attrs, int defStyle) {
	...
	//	setCacheColorHint(context.getResources().getColor(R.color.detail_activity_bg_color));
		...
		headView = inflater.inflate(R.layout.fragment_listview_head,null);
...
//		System.out.println("resultSize :: "+resultSize);
	...
	public void onRefreshComplete() {
		state = DONE;
//		lastUpdatedTextView.setText("������:" + DateUtil.getCurrentTime());
		changeHeaderViewByState();
	}
